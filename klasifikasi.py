...
if selected == "Home":
    ...
    with col1:
        ...
        AgGrid(df, width='100%', fit_columns_on_grid_load=True, height=175)
    ...
    if img_file_buffer is not None:
        ...
        if result:
            ...
            googlenet_pred.compile(optimizer=opt, loss=['categorical_crossentropy', 'categorical_crossentropy', 'categorical_crossentropy'], metrics=["accuracy"])

            out = googlenet_pred.predict(img) # The model has three outputs
